...
const Profile = ({ isProfilOpen, toggleModal }) => {
  return (
      ...
      <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
        <main className="pa4 black-80 w-80">
          ...
          <div className='mt4' style={{display:'flex', justifyContent: 'space-evenly'}}>
            <button className='b pa2 grow ponter hower-white w-40 bg-light-blue b--black-20'>Save</button>
            <button className='b pa2 grow ponter hower-white w-40 bg-light-red b--black-20'
            onClick={toggleModal}>Cancel</button>
          </div>
        </main>
        <div className='modal-close pointer'
